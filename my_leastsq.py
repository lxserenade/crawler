...
def leastsq_plot(y,date):
	...
	ax2.set_xlim(0,100)
	ax2.set_xlabel("index of video")
	ax2.set_ylabel("popular degree")
	ax3 = fig.add_subplot(2,1,2)
	ax3.loglog(x,powerlaw(plsq[0],x),label=u"fit")
	ax3.loglog(x,y1,'ro')
	ax3.set_xlabel("index of video")
	ax3.set_ylabel("popular degree")
	# ax1.grid(True)
	ax2.grid(True)
	ax3.grid(True)
	ax2.set_title(str(date)+" parameter:"+str(plsq[0]))
